...
<body class="container-fluid d-flex flex-column min-vh-100">
    ...
    <div class="main">
        <div class="container mt-4">
            ...
            <form action="<?php echo site_url('Tehkita/update_pelanggan') ?>" method="post">
                <input type="hidden" name="kode" value="<?php echo $pelanggan->id_pelanggan; ?>">
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama Pelanggan</label>
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $pelanggan->nama_pelanggan; ?>">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="text" class="form-control" id="email" name="email" value="<?php echo $pelanggan->email_pelanggan; ?>">
                </div>
