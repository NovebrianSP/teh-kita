...
<body class="container-fluid d-flex flex-column min-vh-100">
    ...
    <div class="main">
        <div class="container mt-4">
            ...
            <form action="<?php echo site_url('Tehkita/tambah_aksi') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Karyawan">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="pass" name="pass" placeholder="Masukkan Password">
                </div>
                <div class="mb-3">
